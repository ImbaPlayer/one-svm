...
# python pcap2csv.py --pcap /data/xgr/sketch_data/caida_dirA/equinix-nyc.dirA.20190117-130000.UTC.anon.pcap --csv /data/sym/one-class-svm/data/mean_of_five/packet-level/caida-A-50W-0.csv
# python pcap2csv.py --pcap /data/xgr/sketch_data/imc_univ1/univ1_pt1 --csv /data/sym/one-class-svm/data/univ1/mean_of_five/packet-level/univ1-50W-1.csv