...
def mice_outliers(num):
    fileName1 = "/data/sym/one-class-svm/data/5-tuple/dec-feature/caida-A-50W-{}.csv".format(num)
    fileName2 = "/data/sym/one-class-svm/data/5-tuple/bin-feature/caida-A-50W-{}.csv".format(num)
