...
def main(num):
    fileName = "/data/sym/one-class-svm/data/5-tuple/dec-feature/caida-A-50W-{}.csv".format(num)
    saveName = "/data/sym/one-class-svm/data/5-tuple/bin-feature/caida-A-50W-{}.csv".format(num)
    # fileName = "1.csv"
    # saveName = "2.csv"
