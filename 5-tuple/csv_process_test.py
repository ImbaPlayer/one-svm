...
def new_extract(num):
    inputName = "/data/sym/one-class-svm/data/offline-5/packet-level/caida-A-50W-{}.csv".format(num)
    saveName = "/data/sym/one-class-svm/data/5-tuple/dec-feature/caida-A-50W-{}.csv".format(num)
    #指定分隔符为/t
