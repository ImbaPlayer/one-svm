...
def new_extract(num):
    inputName = "/data/sym/one-class-svm/data/offline-all/packet-level/caida-A-50W-{}.csv".format(num)
    # inputName = "original.csv"
    saveName = "/data/sym/one-class-svm/data/offline-all/dec-feature/caida-A-50W-{}.csv".format(num)
    # saveName = "1.csv"
    #指定分隔符为/t
