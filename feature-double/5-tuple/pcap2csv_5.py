...
# python pcap2csv_5.py --pcap H:\exp_data\pcap_data\caida-50w-1.pcap --csv original.csv
# python pcap2csv_5.py --pcap /data/xgr/sketch_data/caida_dirA/equinix-nyc.dirA.20190117-130000.UTC.anon.pcap --csv /data/sym/one-class-svm/data/5-tuple/packet-level/caida-A-50W-0.csv