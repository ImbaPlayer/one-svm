...
def main(num):
    fileName = "/data/sym/one-class-svm/data/count/dec-feature/caida-A-50W-{}.csv".format(11)
    saveName = "/data/sym/one-class-svm/data/count/bin-feature/caida-A-50W-{}.csv".format(11)
